...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_carts_currency" AS ENUM('MVR');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('processing', 'completed', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_currency" AS ENUM('MVR');
  CREATE TYPE "public"."enum_transactions_status" AS ENUM('pending', 'succeeded', 'failed', 'cancelled', 'expired', 'refunded');
  CREATE TYPE "public"."enum_transactions_currency" AS ENUM('MVR');
  CREATE TYPE "public"."enum_quotations_status" AS ENUM('draft', 'sent', 'expired');
  ...
  CREATE TABLE "variants" (
  	...
  	"price_in_m_v_r_enabled" boolean,
  	"price_in_m_v_r" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_variants_v" (
  	...
  	"version_price_in_m_v_r_enabled" boolean,
  	"version_price_in_m_v_r" numeric,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "carts" (
  	...
  	"subtotal" numeric,
  	"currency" "enum_carts_currency" DEFAULT 'MVR',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "orders" (
  	...
  	"amount" numeric,
  	"currency" "enum_orders_currency" DEFAULT 'MVR',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "transactions" (
  	...
  	"cart_id" integer,
  	"amount" numeric,
  	"currency" "enum_transactions_currency" DEFAULT 'MVR',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "quotations" (
  	...
  	"status" "enum_quotations_status" DEFAULT 'draft',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "quotations_items" ADD CONSTRAINT "quotations_items_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "quotations_items" ADD CONSTRAINT "quotations_items_variant_id_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."variants"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "quotations_items" ADD CONSTRAINT "quotations_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."quotations"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "quotations" ADD CONSTRAINT "quotations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "quotations_items_order_idx" ON "quotations_items" USING btree ("_order");
  CREATE INDEX "quotations_items_parent_id_idx" ON "quotations_items" USING btree ("_parent_id");
  CREATE INDEX "quotations_items_product_idx" ON "quotations_items" USING btree ("product_id");
  CREATE INDEX "quotations_items_variant_idx" ON "quotations_items" USING btree ("variant_id");
  CREATE INDEX "quotations_user_idx" ON "quotations" USING btree ("user_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "quotations_items" CASCADE;
  ...
  DROP TYPE "public"."enum_quotations_status";
